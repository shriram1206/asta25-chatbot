    ...
    >
      {actions.map((action, index) => (
        <motion.button
          ...
          className="flex items-center gap-1.5 sm:gap-2 px-4 sm:px-5 py-2.5 bg-white/80 backdrop-blur-xl rounded-full text-apple-dark text-xs sm:text-sm font-medium hover:bg-white hover:shadow-md transition-all border border-white/60 shadow-sm focus:outline-none focus:ring-2 focus:ring-apple-blue/40 focus:ring-offset-2 focus:ring-offset-transparent min-h-[44px] whitespace-nowrap"
        >
